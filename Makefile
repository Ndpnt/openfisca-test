...
install: deps
	...
	@# `make install` installs the editable version of openfisca-test.
...
test: clean check-syntax-errors check-style
	openfisca test --country-package openfisca_test openfisca_test/tests

serve-local: build
	openfisca serve --country-package openfisca_test
